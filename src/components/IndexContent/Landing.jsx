...
export const Landing = () => {
  return (
    <section className='bgLanding w-screen h-screen  ' id='section1'>
        <div className='bgBlur h-screen w-screen flex justify-around items-center boxShadow   '>
            <div className='text-white flex flex-col '>
                ...
                <div className='mt-3 flex flex-col sm:flex-row items-center'>
                    ...
                    <ButtonLanding Label={'Show more'} Link={'#section2'}/>
                </div>
